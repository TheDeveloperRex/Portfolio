require( "ui.uieditor.widgets.REX.ColdWar.Revive.ZM_ReviveBleedoutRedEyeGlow" )
require( "ui.uieditor.widgets.HUD.core_AmmoWidget.AmmoWidget_AbilityGlow" )

CoD.CWReviveWidget = InheritFrom( LUI.UIElement )
CoD.CWReviveWidget.new = function ( menu, controller )
	...
	self:setClass( CoD.CWReviveWidget )
	self.id = "CWReviveWidget"
