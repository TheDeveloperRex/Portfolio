...
function CoD.MenuListItemWidget.new(HudRef, InstanceRef)
    ...
    Widget:setLeftRight(true, true, -50, 50)
    Widget:setTopBottom(true, true, -50, 50)
    ...
    Widget.Background:setImage(RegisterImage("$blacktransparent"))
    ...
    Widget.clipsPerState = {
        DefaultState = {
            DefaultClip = function()
                ...
                Widget.CraftableItemIcon:setRGB(0.8, 0.8, 0.8)
                Widget.CraftableItemIcon:setAlpha(0.65)
            ...
            GainFocus = function()
                ...
                local function HandleFocusCraftableClip(Sender, Event)
                ...
                Widget.CraftableItemIcon:setRGB(0.8, 0.8, 0.8)
                Widget.CraftableItemIcon:setAlpha(0.65)
                HandleFocusCraftableClip(Widget.CraftableItemIcon, {})
            end,
            LoseFocus = function()
                Widget:setupElementClipCounter(3)
