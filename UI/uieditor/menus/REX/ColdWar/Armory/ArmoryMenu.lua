require( "ui.uieditor.menus.REX.ColdWar.Armory.ArmoryMenu_TabBar" )
...
LUI.createMenu.ArmoryMenu = function( controller )

    local self = CoD.Menu.NewForUIEditor( "ArmoryMenu" )
    ...
    self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "ArmoryMenu.buttonPrompts" )
    ...
    local CustomTabBar = CoD.ArmoryMenu_TabBar.new( self, controller )
    ...
    LUI.OverrideFunction_CallOriginalSecond( self, "close", function( element )
        ...
        Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "ArmoryMenu.buttonPrompts" ) )
    end)
