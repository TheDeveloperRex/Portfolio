...
require( "ui.uieditor.menus.REX.ColdWar.Armory.ArmoryMenu_Tab1" )
require( "ui.uieditor.menus.REX.ColdWar.Armory.ArmoryMenu_Tab2" )

CoD.ArmoryMenu_TabBar = InheritFrom( LUI.UIElement )
CoD.ArmoryMenu_TabBar.SizeTabsToWidth = function( TabBar, Width )
...
DataSources.ArmoryTabBar = DataSourceHelpers.ListSetup( "ArmoryTabBar", function( controller )
    local dataTable = {
        {
            models = {
                tabName = "ARMOR",
                tabWidget = "CoD.ArmoryMenu_Tab1",
                tabIcon = ""
            },
            properties = {
                tabId = "ArmoryMenu_Tab1"
            }
        },
        {
            models = {
                tabName = "WEAPON",
                tabWidget = "CoD.ArmoryMenu_Tab2",
                tabIcon = ""
            },
            properties = {
                tabId = "ArmoryMenu_Tab2"
            }
        }
    }
    return dataTable
...
CoD.ArmoryMenu_TabBar.new = function( menu, controller )
    ...
    self:setClass( CoD.ArmoryMenu_TabBar )
    self.id = "ArmoryMenu_TabBar"
    ...
    grid:setDataSource( "ArmoryTabBar" )
